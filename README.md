...
**We have a new upcoming migration project where we will take project area base from platform and integrate project-specific implementation on top of it. The learning from this training would be helpful in refactoring the code and then integrating the same to the project stream. It will also be applied to new codes as there is scope of new code imlementation in the new projects. We will plan to bring in bettter modularity, codes with better testability and rediced cyclometric complexity and understandability**
