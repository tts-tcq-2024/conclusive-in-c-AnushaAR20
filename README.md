...
**We have a new upcoming migration project where we will take project area base from platform and integrate project-specific implementation on top of it. The learning from this training would be helpful in refactoring the code and then integrating the same to the project stream. Learning from these sessions will also be applied to new codes as there is scope of new feature implementation in the new project. We will plan to bring in bettter modularity, codes with better testability and rediced cyclometric complexity and understandability**
